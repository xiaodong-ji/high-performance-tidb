...
- 运行测试
```
# ./bin/go-tpc tpcc -H 192.168.0.19 -P 4000 -D tpcc --warehouses 10 run --time 1m --threads 4
......
Finished
[Summary] DELIVERY - Takes(s): 35.5, Count: 6, TPM: 10.1, Sum(ms): 21319, Avg(ms): 3553, 90th(ms): 4000, 99th(ms): 4000, 99.9th(ms): 4000
[Summary] DELIVERY_ERR - Takes(s): 35.5, Count: 1, TPM: 1.7, Sum(ms): 1103, Avg(ms): 1103, 90th(ms): 1500, 99th(ms): 1500, 99.9th(ms): 1500
[Summary] NEW_ORDER - Takes(s): 58.2, Count: 109, TPM: 112.4, Sum(ms): 113996, Avg(ms): 1045, 90th(ms): 1500, 99th(ms): 2000, 99.9th(ms): 2000
[Summary] NEW_ORDER_ERR - Takes(s): 58.2, Count: 2, TPM: 2.1, Sum(ms): 434, Avg(ms): 217, 90th(ms): 256, 99th(ms): 256, 99.9th(ms): 256
[Summary] ORDER_STATUS - Takes(s): 56.0, Count: 6, TPM: 6.4, Sum(ms): 986, Avg(ms): 164, 90th(ms): 512, 99th(ms): 512, 99.9th(ms): 512
[Summary] PAYMENT - Takes(s): 59.3, Count: 118, TPM: 119.3, Sum(ms): 99199, Avg(ms): 840, 90th(ms): 1500, 99th(ms): 2000, 99.9th(ms): 4000
[Summary] STOCK_LEVEL - Takes(s): 56.7, Count: 4, TPM: 4.2, Sum(ms): 2470, Avg(ms): 617, 90th(ms): 1000, 99th(ms): 1000, 99.9th(ms): 1000
tpmC: 112.4
```
